...
class PolicyEngine {
  ...
  /**
   * Load a Rego policy from file or string (interpreter mode)
   * Note: WASM support removed due to compatibility issues.
   * Use OPA CLI to test policies: opa eval -i input.json policy.rego
   */
